...
//	@ManyToOne
//	@JoinColumn(name = "pipActionId", foreignKey = @ForeignKey(name = "pip_task_pip_actionId_fk"), referencedColumnName = "id")
//	private PipAction pipAction;
	
//	@ManyToOne private PipAction pipAction;
